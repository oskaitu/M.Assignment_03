...
type BroadcastClient interface {
	...
	BroadcastMesssage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Close, error)
}
...
func (c *broadcastClient) BroadcastMesssage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Close, error) {
	out := new(Close)
	err := c.cc.Invoke(ctx, "/proto.Broadcast/BroadcastMesssage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Broadcast_BroadcastMesssage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BroadcastServer).BroadcastMesssage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Broadcast/BroadcastMesssage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BroadcastServer).BroadcastMesssage(ctx, req.(*Message))
	}
...
var Broadcast_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "BroadcastMesssage",
			Handler:    _Broadcast_BroadcastMesssage_Handler,
		},
	},
